import { AlarmClockCheck, ArrowRight, Blend, CalendarCheck, Ellipsis, FileText, Folder, Gauge, SquarePlay, Star } from "lucide-react";
              ...
              <section className="bg-white p-5 sm:p-6 rounded-xl border border-slate-100 shadow-sm">
                ...
                <div className="space-y-0">
                  {[
                    ...
                    ({ dot, title, time, sub, badge, showAvatars }, i, arr) => (
